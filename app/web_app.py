...
def create_web_app(llm: llm_model.BaseLLM) -> Flask:
	app = Flask(__name__)
	app.config['SECRET_KEY'] = os.urandom(32).hex()
	init_web_app(app, llm)
	return app


def run_web_app(app: Flask, host: str, port: int):
...
def init_web_app(app: Flask, llm: llm_model.BaseLLM):
